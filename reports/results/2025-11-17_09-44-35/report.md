...
_Last updated: 2025-11-17 09:44:35 UTC_
...
| Package | Patches Applied | Original | Patched | Result |
|---------|----------------|--------|-------|--------|
| `invenio-banners` <br/> [patched](packages/invenio-banners/test-output-patched.txt) [warnings-patched](packages/invenio-banners/warnings-patched.md) | pytest-invenio invenio-files-rest | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
...
| `invenio-config` <br/> [patched](packages/invenio-config/test-output-patched.txt) [warnings-patched](packages/invenio-config/warnings-patched.md) | pytest-invenio | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
...
| `invenio-oauthclient` <br/> [patched](packages/invenio-oauthclient/test-output-patched.txt) [warnings-patched](packages/invenio-oauthclient/warnings-patched.md) | pytest-invenio | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
...
| `invenio-notifications` <br/> [patched](packages/invenio-notifications/test-output-patched.txt) [warnings-patched](packages/invenio-notifications/warnings-patched.md) | pytest-invenio invenio-files-rest | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
...
| `invenio-app` <br/> [patched](packages/invenio-app/test-output-patched.txt) [warnings-patched](packages/invenio-app/warnings-patched.md) | pytest-invenio | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
| `invenio-jobs` <br/> [patched](packages/invenio-jobs/test-output-patched.txt) [warnings-patched](packages/invenio-jobs/warnings-patched.md) | pytest-invenio invenio-files-rest | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
...
| `invenio-pidstore` <br/> [patched](packages/invenio-pidstore/test-output-patched.txt) [warnings-patched](packages/invenio-pidstore/warnings-patched.md) | pytest-invenio | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
...
| `invenio-indexer` <br/> [patched](packages/invenio-indexer/test-output-patched.txt) [warnings-patched](packages/invenio-indexer/warnings-patched.md) | pytest-invenio | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
| `invenio-oaiserver` <br/> [patched](packages/invenio-oaiserver/test-output-patched.txt) [warnings-patched](packages/invenio-oaiserver/warnings-patched.md) | pytest-invenio | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
| `invenio-drafts-resources` <br/> [patched](packages/invenio-drafts-resources/test-output-patched.txt) [warnings-patched](packages/invenio-drafts-resources/warnings-patched.md) | pytest-invenio invenio-files-rest | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
| `invenio-access` <br/> [original](packages/invenio-access/test-output-original.txt) [patched](packages/invenio-access/test-output-patched.txt) [warnings-original](packages/invenio-access/warnings-original.md) [warnings-patched](packages/invenio-access/warnings-patched.md) | pytest-invenio | ❌ Fail | ❌ Fail | ⚠️ Tests still failing after patch |
| `invenio-rest` <br/> [patched](packages/invenio-rest/test-output-patched.txt) [warnings-patched](packages/invenio-rest/warnings-patched.md) | pytest-invenio | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
...
| `invenio-records-permissions` <br/> [patched](packages/invenio-records-permissions/test-output-patched.txt) [warnings-patched](packages/invenio-records-permissions/warnings-patched.md) | pytest-invenio | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
| `invenio-app-rdm` <br/> [patched](packages/invenio-app-rdm/test-output-patched.txt) [warnings-patched](packages/invenio-app-rdm/warnings-patched.md) | pytest-invenio invenio-files-rest | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
| `invenio-collections` <br/> [patched](packages/invenio-collections/test-output-patched.txt) [warnings-patched](packages/invenio-collections/warnings-patched.md) | pytest-invenio invenio-files-rest | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
| `invenio-records-ui` <br/> [patched](packages/invenio-records-ui/test-output-patched.txt) [warnings-patched](packages/invenio-records-ui/warnings-patched.md) | pytest-invenio | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
...
| `invenio-userprofiles` <br/> [patched](packages/invenio-userprofiles/test-output-patched.txt) [warnings-patched](packages/invenio-userprofiles/warnings-patched.md) | pytest-invenio | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
| `invenio-previewer` <br/> [patched](packages/invenio-previewer/test-output-patched.txt) [warnings-patched](packages/invenio-previewer/warnings-patched.md) | pytest-invenio invenio-files-rest | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
| `invenio-communities` <br/> [patched](packages/invenio-communities/test-output-patched.txt) [warnings-patched](packages/invenio-communities/warnings-patched.md) | pytest-invenio invenio-files-rest | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
| `invenio-search-ui` <br/> [patched](packages/invenio-search-ui/test-output-patched.txt) | pytest-invenio | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
...
| `invenio-logging` <br/> [patched](packages/invenio-logging/test-output-patched.txt) [warnings-patched](packages/invenio-logging/warnings-patched.md) | pytest-invenio | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
| `invenio-sitemap` <br/> [patched](packages/invenio-sitemap/test-output-patched.txt) [warnings-patched](packages/invenio-sitemap/warnings-patched.md) | pytest-invenio | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
...
| `invenio-checks` <br/> [patched](packages/invenio-checks/test-output-patched.txt) [warnings-patched](packages/invenio-checks/warnings-patched.md) | pytest-invenio invenio-files-rest | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
...
| `invenio-records-rest` <br/> [patched](packages/invenio-records-rest/test-output-patched.txt) [warnings-patched](packages/invenio-records-rest/warnings-patched.md) | pytest-invenio | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
| `invenio-administration` <br/> [patched](packages/invenio-administration/test-output-patched.txt) [warnings-patched](packages/invenio-administration/warnings-patched.md) | pytest-invenio invenio-files-rest | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
| `invenio-records-resources` <br/> [patched](packages/invenio-records-resources/test-output-patched.txt) [warnings-patched](packages/invenio-records-resources/warnings-patched.md) | pytest-invenio invenio-files-rest | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
| `invenio-github` <br/> [original](packages/invenio-github/test-output-original.txt) [patched](packages/invenio-github/test-output-patched.txt) [warnings-original](packages/invenio-github/warnings-original.md) [warnings-patched](packages/invenio-github/warnings-patched.md) | pytest-invenio invenio-files-rest | ❌ Fail | ❌ Fail | ⚠️ Tests still failing after patch |
...
| `invenio-oauth2server` <br/> [patched](packages/invenio-oauth2server/test-output-patched.txt) [warnings-patched](packages/invenio-oauth2server/warnings-patched.md) | pytest-invenio | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
| `invenio-jsonschemas` <br/> [patched](packages/invenio-jsonschemas/test-output-patched.txt) [warnings-patched](packages/invenio-jsonschemas/warnings-patched.md) | pytest-invenio | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
...
| `invenio-search` <br/> [original](packages/invenio-search/test-output-original.txt) [patched](packages/invenio-search/test-output-patched.txt) | pytest-invenio | ❌ Fail | ❌ Fail | ⚠️ Tests still failing after patch |
| `invenio-accounts` <br/> [patched](packages/invenio-accounts/test-output-patched.txt) [warnings-patched](packages/invenio-accounts/warnings-patched.md) | pytest-invenio | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
| `invenio-users-resources` <br/> [patched](packages/invenio-users-resources/test-output-patched.txt) [warnings-patched](packages/invenio-users-resources/warnings-patched.md) | pytest-invenio invenio-files-rest | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
| `invenio-webhooks` <br/> [patched](packages/invenio-webhooks/test-output-patched.txt) [warnings-patched](packages/invenio-webhooks/warnings-patched.md) | pytest-invenio | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
| `invenio-records` <br/> [patched](packages/invenio-records/test-output-patched.txt) [warnings-patched](packages/invenio-records/warnings-patched.md) | pytest-invenio | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |

## Collected Warnings

### Patched

#### Warning 1 - 207 occurrences
...
SAWarning: Identity map already had an identity for (<class 'invenio_jobs.models.Run'>, (UUID('50f6cf04-b6dc-4965-a761-295c23796a1c'),), None), replacing it with newly flushed object.   Are there load operations occurring inside of an event handler within the flush?
...
SAWarning: Identity map already had an identity for (<class 'invenio_jobs.models.Run'>, (UUID('865843ca-f519-48a5-baaf-5fbdc25cde5b'),), None), replacing it with newly flushed object.   Are there load operations occurring inside of an event handler within the flush?
...
SAWarning: Identity map already had an identity for (<class 'invenio_jobs.models.Run'>, (UUID('d108b9ab-e6b6-4019-bbe0-cc35069cf6f1'),), None), replacing it with newly flushed object.   Are there load operations occurring inside of an event handler within the flush?
...
SAWarning: Identity map already had an identity for (<class 'invenio_jobs.models.Run'>, (UUID('e18b0c2f-5194-44fa-875b-b6e874276ff4'),), None), replacing it with newly flushed object.   Are there load operations occurring inside of an event handler within the flush?
...
SAWarning: Identity map already had an identity for (<class 'invenio_jobs.models.Run'>, (UUID('ed880946-4039-42cc-b11f-dc89a9853c9d'),), None), replacing it with newly flushed object.   Are there load operations occurring inside of an event handler within the flush?
...
SAWarning: Identity map already had an identity for (<class 'invenio_jobs.models.Run'>, (UUID('f104189f-fd49-4a29-8b89-5be43e7fd41c'),), None), replacing it with newly flushed object.   Are there load operations occurring inside of an event handler within the flush?
...
SAWarning: Identity map already had an identity for (<class 'invenio_jobs.models.Run'>, (UUID('f8c36d49-1500-4cdf-bbd4-77b75773776e'),), None), replacing it with newly flushed object.   Are there load operations occurring inside of an event handler within the flush?
